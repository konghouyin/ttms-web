            ...
            for(let i = 0 ; i < n; i++ ){                 
                if (responseText.style == 1) {
                    ...
                    if( rila == day0 ){
                        ...
                        var shi = myDate.getHours(myDate);
                        var fen = myDate.getMinutes(myDate);
                        jumuitem0.innerHTML += `
                        <div class="jumu-item " style="display:block" id="jumu-item">
                            <div class="time" id="time">
                                <div class="time-start" id="time-start">`+ shi +':'+ fen +`</div>
...
function xuanzuo(e){
    ...
    var flag=0;
    if(e.children[0].src =="../image/座位空.png"){
        e.children[0].src = "../image/座位已选.png";
    ...
    // 取消选择
    else if(e.children[0].src== "../image/座位已选.png"){
